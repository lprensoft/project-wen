...
//
// 五类定义必须与 memory.go 的 promptGuide 逐句同源。这两份判据一份管当场保存、
...
{"memories":[{"name":"简短标题","description":"一句话摘要","type":"偏好|约定|事实|踩坑|经历","content":"完整内容","mode":"create|replace"%s}],"mentioned":["分类/标题"]}
